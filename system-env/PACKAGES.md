...
```
sudo pacman -S fzf bat picom feh
```
...
| `picom` | X11 compositor — required for kitty `background_opacity 0.92` and window fading. |
...
```
cd ~/my-i3-dotfiles
stow picom            # symlinks ~/.config/picom/picom.conf
```
